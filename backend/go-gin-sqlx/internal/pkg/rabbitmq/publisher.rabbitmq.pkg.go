...
func (p *Publisher) consumeReplyQueue(ctx context.Context, replyQueue *amqp.Queue, payload *amqp.Publishing) (interface{}, error) {
	ch, err := p.channelManager.GetChannel()
