<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="card mb-6">
        <div class="flex items-center space-x-6">
            <img
                src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()?->name ?? 'User') }}&size=128&background=f48024&color=fff"
                alt="Profile"
                class="h-24 w-24 rounded-full"
            >
            <div>
                <h1 class="text-2xl font-bold text-brand-dark">{{ auth()->user()?->name ?? 'User' }}</h1>
